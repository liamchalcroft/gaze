...
```python
from nova_retrieval_vlm.agentic import AblationProcessor
from nova_retrieval_vlm.agentic.ablation_study import AblationConfigs

# Create processor for analysis
processor = AblationProcessor(
    model_config={"name": "x-ai/grok-4.1-fast:free"},
    task="diagnosis",
    paths_config={"data_dir": "./data/nova"},
    ablation_config={
        "ablation_mode": "reasoning_impact",
