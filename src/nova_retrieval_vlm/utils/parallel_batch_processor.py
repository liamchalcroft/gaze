...
class ParallelBatchProcessor:
    ...
    def __init__(
        ...
        logger.info(f"Initialized ParallelBatchProcessor: {self.max_workers} workers, "
    ...
    def process_batches_parallel(
        ...
        **kwargs
        ...
        logger.info(f"Processing {len(batches)} batches in parallel with {self.max_workers} workers")
        start_time = time.time()
        
        with executor_class(max_workers=self.max_workers) as executor:
            # Submit all batch jobs
            future_to_idx = {
                executor.submit(process_func, idx, batch): idx 
        ...
        logger.info(f"Parallel batch processing completed in {elapsed:.2f}s "
...
def parallel_batch_wrapper(
    ...
    def wrapped_processor(
        ...
        **kwargs
        ...
        return processor.process_batches_parallel(
            original_process_func, batches, **kwargs
        )
